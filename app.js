...
var isItNight = false;
  ...
  if (navigator.geolocation) {
     ...
     function dayNight () {
       ...
       $.ajax({
         ...
         success: function(response){
           ...
           var sunriseU = Math.round(moment.utc(sunrise)/1000);
           var sunsetU = Math.round(moment.utc(sunset)/1000);

           //console.log("sunriseU is " + sunriseU);
           //console.log("sunsetU is " + sunsetU);
           //console.log("time is" + time);
           if (time < sunriseU || time >= sunsetU ) {
    ...
    $.ajax({
      ...
      success: function(response){
        ...
        //Toggles Celsius and Fahrenheit
        var tempSwap = false;
        ...
        //Raises thermometer level according to temperature
        if (tempC >= 0 && tempC < 10 ) {
        ...
        //Replaces loading icon with weather icon
  ...
  //removes focus styling after user has clicked button and moved cursor away
